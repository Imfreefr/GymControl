...
<a href="painel_admin.php" class="p-2 text-decoration-none"><i class="bi bi-speedometer2"></i> Dashboard</a>
<a href="alunos.php" class="active p-2 text-decoration-none"><i class="bi bi-people"></i> Alunos</a>
...
<?php if($msg): ?><div class="alert alert-success py-2 small"><?= e($msg) ?></div><?php endif; ?>
...
<thead class="table-light"><tr><th>Nome</th><th>E-mail</th><th>Telefone</th><th>Objetivo</th><th>Status</th><th>Ações</th></tr></thead>
<tbody>
<?php if(empty($alunos)): ?><tr><td colspan="6" class="text-center small text-muted py-3">Nenhum aluno encontrado.</td></tr>
...
<td><span class="badge <?= $a['status']==='ativo'?'bg-success':'bg-secondary' ?>"><?= e($a['status']) ?></span></td>
