 ...
 *
 * Formulário para cadastro de novos alunos. Processa dados via POST,
 * valida token CSRF, delega criação ao AlunoController e persiste
 * no banco via Model com PDO.
 *
 * Fluxo: Autenticação admin -> POST + CSRF -> Controller -> Model -> Redirect
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_validar($_POST['csrf'] ?? null)) {
        ...
        [$ok, $ret] = $ctrl->cadastrarAluno(
            ...
            trim($_POST['senha'] ?? 'Aluno123!')
        );

        $msg = $ret;

        if ($ok) {
            header('Location: alunos.php?msg=' . urlencode($ret));
            exit;
        }
    }
}
        ...
        <div class="d-flex">
            ...
            <aside class="sidebar p-3" style="width: 260px;">
                ...
                <nav class="d-flex flex-column gap-1">
                    ...
                    <a href="alunos.php" class="active p-2 text-decoration-none">Alunos</a>
                </nav>
            </aside>
                ...
                <form method="POST" class="card card-gym border-0 p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="senha" class="form-control" value="Aluno123!">
