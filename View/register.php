...
<figure class="rounded-circle d-flex justify-content-center align-items-center bgLinearGradient"><i class="bi bi-lightning-charge-fill fs-5 text-white"></i></figure>
...
<button type="submit" class="border-0 text-white rounded-3 w-100 mb-3 p-2 bgLinearGradient">Cadastrar</button>
<p class="text-center small">Já tem conta? <a href="../index.php">Faça login</a></p>
</form>
</main>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.6/dist/js/bootstrap.bundle.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/toastify-js"></script>
<script><?php if(!empty($msg)): ?>Toastify({text:<?= json_encode(strip_tags($msg)) ?>,duration:3500,close:true,gravity:"bottom",position:"right",style:{background:"hsl(6 78% 57%)"}}).showToast();<?php endif; ?></script>
</body>
</html>
