...
/**
 * GymControl - Minha Frequência (Aluno)
 *
 * Exibe o histórico de presenças do aluno autenticado, com total
 * acumulado e total do mês atual. Acesso restrito a perfil aluno;
 * administradores são redirecionados ao painel admin.
 *
 * Fluxo: Autenticação -> Controller Aluno -> Model Frequencia (PDO) -> View
 */
            ...
            <div class="row g-3 mb-3">
                <div class="col-6 col-md-4">
                    <div class="stat-card p-3 text-center">
                        ...
                        <h3 class="fw-bold" style="color: #ea580c;"><?= $total ?></h3>
                        <small class="text-muted">presenças</small>
                    </div>
                </div>
                <div class="col-6 col-md-4">
                    <div class="stat-card p-3 text-center">
                        <small class="text-muted">No mês (<?= date('m/Y') ?>)</small>
                        <h3 class="fw-bold" style="color: #ea580c;"><?= $mes ?></h3>
                        <small class="text-muted">presenças</small>
                    </div>
                </div>
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                <?php if (empty($historico)) : ?>
                                    <tr>
                                        <td colspan="2" class="text-muted small">Nenhum registro.</td>
                                    </tr>
                                <?php else : ?>
